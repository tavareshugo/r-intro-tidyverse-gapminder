...
└── data
    └── raw
        ├── gapminder1960to2010_energy.csv
...
The text after each line of code is called a **[comment](../reference.html#comment)**. 
...
For example, to install (or update) the `tidyverse` package, run the following 
